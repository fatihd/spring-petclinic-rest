...
/**
 * Test class for {@link OwnersRestController}
 *
...
@WebAppConfiguration
class OwnersRestControllerTests {

    @Autowired
    OwnersRestController ownersRestController;
    ...
    @BeforeEach
    void initOwners() {
        this.mockMvc = MockMvcBuilders.standaloneSetup(ownersRestController)
